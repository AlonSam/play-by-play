...
from pbp.resources.enhanced_pbp import FieldGoal, FreeThrow, Rebound, Turnover
...
class EnhancedPbp(Base):
    ...
    :param list events: list of
        :obj:`~pbp.resources.enhanced_pbp.enhanced_pbp_item.EnhancedPbpItem` items,
    ...
    def fgas(self):
        """
        returns list of :obj:`~pbp.resources.enhanced_pbp.field_goal.FieldGoal` events
        """
    ...
    def fgms(self):
        """
        returns list of :obj:`~pbp.resources.enhanced_pbp.field_goal.FieldGoal` events with all made FGs
        """
        return [
    ...
    def ftas(self):
        """
        returns list of :obj:`~pbp.resources.enhanced_pbp.free_throw.FreeThrow` events
        """
    ...
    def rebounds(self):
        """
        returns list of :obj:`~pbp.resources.enhanced_pbp.field_goal.Rebound` events
        """
        return [
            item
    ...
    def turnovers(self):
        """
        returns list of :obj:`~pbp.resources.enhanced_pbp.field_goal.Turnover` events
        """
        return [
            item
            for item in self.items
